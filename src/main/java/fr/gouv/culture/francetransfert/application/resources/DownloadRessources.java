...
public class DownloadRessources {
	...
	public Download generateDownloadUrlWithPassword(HttpServletResponse response,
			@RequestParam("enclosure") String enclosureId, @RequestParam("recipient") String recipientMail,
		...
		LOGGER.info(
				"===========================================================================================================================");
		Download downloadURL = downloadServices.generateDownloadUrlWithPassword(enclosureId, recipientMail, recipientId,
				password);
	...
	public DownloadRepresentation downloadinfo(HttpServletResponse response,
			@RequestParam("enclosure") String enclosureId, @RequestParam("recipient") String recipientMailInBase64,
		...
		LOGGER.info(
				"===================================================================================================================");
		DownloadRepresentation downloadRepresentation = downloadServices.getDownloadInfo(enclosureId, recipientId,
				recipientMailInBase64);
		response.setStatus(HttpStatus.OK.value());
